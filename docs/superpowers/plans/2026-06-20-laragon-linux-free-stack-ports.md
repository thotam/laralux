# Laragon Linux — Plan 3d: Free Stack Ports from Distro systemd Services Implementation Plan
...
**Tech Stack:** Rust, reuses `laragon_core` (Plans 1–3c); live tool: `systemctl` via pkexec/sudo.
...
Run: `cargo test -p laragon-core setup::tests::run_setup_disables_distro_stack_services`
...
Run: `cargo test -p laragon-core php_fpm::tests::write_config_omits_user_directive`
